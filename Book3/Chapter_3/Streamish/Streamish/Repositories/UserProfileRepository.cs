    ...
    public class UserProfileRepository : BaseRepository, IUserProfileRepository
    {
        ...
        public List<UserProfile> GetAll()
        {
            using (SqlConnection conn = Connection)
            {
                ...
                {
                    cmd.CommandText = @"SELECT up.Id AS UserId, up.Name, up.Email, up.ImageUrl, up.DateCreated AS UserDateCreated,
                                        vid.Id AS VideoId, vid.Title, vid.Description, vid.URL, vid.DateCreated AS VideoDateCreated
                                        FROM UserProfile 
                                        LEFT JOIN Video vid 
                                        ON up.Id = vid.UserProfileId";
